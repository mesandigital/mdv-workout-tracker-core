...
const MIGRATIONS = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_workout_template_history_workout ON workout_template_history(workout_id, created_at DESC);`,
  `CREATE INDEX IF NOT EXISTS idx_workout_template_history_session ON workout_template_history(workout_session_id);`,
